...
const rows = [
  createData('zo', '1 sep', '', 'nacht'),
  createData('ma', '2 sep', '', 'nacht'),
  createData('di', '3 sep', '', ''),
  createData('wo', '4 sep', '', ''),
  createData('do', '5 sep', '', 'ochtend'),
  createData('vr', '6 sep', '', 'ochtend'),
  createData('za', '7 sep', '', 'ochtend'),
  createData('zo', '8 sep', '', ''),
  createData('ma', '9 sep', '', ''),
  createData('di', '10 sep', '', 'middag'),
  createData('wo', '11 sep', '', 'middag'),
  createData('do', '12 sep', '', 'nacht'),
  createData('vr', '13 sep', '', 'nacht'),
  createData('za', '14 sep', '', ''),
  createData('zo', '15 sep', '', ''),
  createData('ma', '16 sep', '', 'ochtend'),
  createData('di', '17 sep', '', 'ochtend'),
  createData('wo', '18 sep', '', 'ochtend'),
  createData('do', '19 sep', '', 'middag'),
  createData('vr', '20 sep', '', 'middag'),
  createData('za', '21 sep', '', ''),
  createData('zo', '22 sep', '', ''),
  createData('ma', '23 sep', '', 'middag'),
  createData('di', '24 sep', '', 'nacht'),
  createData('wo', '25 sep', '', 'nacht'),
  createData('do', '26 sep', '', ''),
  createData('vr', '27 sep', '', ''),
  createData('za', '28 sep', '', 'middag'),
  createData('zo', '29 sep', '', 'nacht'),
  createData('ma', '30 sep', '', 'nacht'),
];
