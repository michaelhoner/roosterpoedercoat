...
const rows = [
  createData('vr', '1 nov', '', 'nacht'),
  createData('za', '2 nov', '', ''),
  createData('zo', '3 nov', '', ''),
  createData('ma', '4 nov', '', 'ochtend'),
  createData('di', '5 nov', '', 'ochtend'),
  createData('wo', '6 nov', '', 'ochtend'),
  createData('do', '7 nov', '', 'middag'),
  createData('vr', '8 nov', '', 'middag'),
  createData('za', '9 nov', '', ''),
  createData('zo', '10 nov', '', ''),
  createData('ma', '11 nov', '', 'middag'),
  createData('di', '12 nov', '', 'nacht'),
  createData('wo', '13 nov', '', 'nacht'),
  createData('do', '14 nov', '', ''),
  createData('vr', '15 nov', '', ''),
  createData('za', '16 nov', '', 'middag'),
  createData('zo', '17 nov', '', 'nacht'),
  createData('ma', '18 nov', '', 'nacht'),
  createData('di', '19 nov', '', ''),
  createData('wo', '20 nov', '', ''),
  createData('do', '21 nov', '', 'ochtend'),
  createData('vr', '22 nov', '', 'ochtend'),
  createData('za', '23 nov', '', 'ochtend'),
  createData('zo', '24 nov', '', ''),
  createData('ma', '25 nov', '', ''),
  createData('di', '26 nov', '', 'middag'),
  createData('wo', '27 nov', '', 'middag'),
  createData('do', '28 nov', '', 'nacht'),
  createData('vr', '29 nov', '', 'nacht'),
