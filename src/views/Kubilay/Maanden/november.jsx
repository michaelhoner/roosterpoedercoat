...
const rows = [
  createData('vr', '1 nov', '', ''),
  createData('za', '2 nov', '', 'middag'),
  createData('zo', '3 nov', '', 'nacht'),
  createData('ma', '4 nov', '', 'nacht'),
  createData('di', '5 nov', '', ''),
  createData('wo', '6 nov', '', ''),
  createData('do', '7 nov', '', 'ochtend'),
  createData('vr', '8 nov', '', 'ochtend'),
  createData('za', '9 nov', '', 'ochtend'),
  createData('zo', '10 nov', '', ''),
  createData('ma', '11 nov', '', ''),
  createData('di', '12 nov', '', 'middag'),
  createData('wo', '13 nov', '', 'middag'),
  createData('do', '14 nov', '', 'nacht'),
  createData('vr', '15 nov', '', 'nacht'),
  createData('za', '16 nov', '', ''),
  createData('zo', '17 nov', '', ''),
  createData('ma', '18 nov', '', 'ochtend'),
  createData('di', '19 nov', '', 'ochtend'),
  createData('wo', '20 nov', '', 'ochtend'),
  createData('do', '21 nov', '', 'middag'),
  createData('vr', '22 nov', '', 'middag'),
  createData('za', '23 nov', '', ''),
  createData('zo', '24 nov', '', ''),
  createData('ma', '25 nov', '', 'middag'),
  createData('di', '26 nov', '', 'nacht'),
  createData('wo', '27 nov', '', 'nacht'),
  createData('do', '28 nov', '', ''),
  createData('vr', '29 nov', '', ''),
  createData('za', '30 nov', '', 'middag'),
];
