...
const rows = [
  createData('wo', '1 mei', '', 'nacht'),
  createData('do', '2 mei', '', ''),
  createData('vr', '3 mei', '', ''),
  createData('za', '4 mei', '', 'middag'),
  createData('zo', '5 mei', '', 'nacht'),
  createData('ma', '6 mei', '', 'nacht'),
  createData('di', '7 mei', '', ''),
  createData('wo', '8 mei', '', ''),
  createData('do', '9 mei', '', 'ochtend'),
  createData('vr', '10 mei', '', 'ochtend'),
  createData('za', '11 mei', '', 'ochtend'),
  createData('zo', '12 mei', '', ''),
  createData('ma', '13 mei', '', ''),
  createData('di', '14 mei', '', 'middag'),
  createData('wo', '15 mei', '', 'middag'),
  createData('do', '16 mei', '', 'nacht'),
  createData('vr', '17 mei', '', 'nacht'),
  createData('za', '18 mei', '', ''),
  createData('zo', '19 mei', '', ''),
  createData('ma', '20 mei', '', 'ochtend'),
  createData('di', '21 mei', '', 'ochtend'),
  createData('wo', '22 mei', '', 'ochtend'),
  createData('do', '23 mei', '', 'middag'),
  createData('vr', '24 mei', '', 'middag'),
  createData('za', '25 mei', '', ''),
  createData('zo', '26 mei', '', ''),
  createData('ma', '27 mei', '', 'middag'),
  createData('di', '28 mei', '', 'nacht'),
  createData('wo', '29 mei', '', 'nacht'),
  createData('do', '30 mei', 'Hemelvaartsdag', ''),
  createData('vr', '31 mei', '', ''),
];
