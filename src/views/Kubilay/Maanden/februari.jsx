...
const rows = [
  createData('vr', '1 feb', '', 'ochtend'),
  createData('za', '2 feb', '', 'ochtend'),
  createData('zo', '3 feb', '', ''),
  createData('ma', '4 feb', '', ''),
  createData('di', '5 feb', '', 'middag'),
  createData('wo', '6 feb', '', 'middag'),
  createData('do', '7 feb', '', 'nacht'),
  createData('vr', '8 feb', '', 'nacht'),
  createData('za', '9 feb', '', ''),
  createData('zo', '10 feb', '', ''),
  createData('ma', '11 feb', '', 'ochtend'),
  createData('di', '12 feb', '', 'ochtend'),
  createData('wo', '13 feb', '', 'ochtend'),
  createData('do', '14 feb', '', 'middag'),
  createData('vr', '15 feb', '', 'middag'),
  createData('za', '16 feb', '', ''),
  createData('zo', '17 feb', '', ''),
  createData('ma', '18 feb', '', 'middag'),
  createData('di', '19 feb', '', 'nacht'),
  createData('wo', '20 feb', '', 'nacht'),
  createData('do', '21 feb', '', ''),
  createData('vr', '22 feb', '', ''),
  createData('za', '23 feb', '', 'middag'),
  createData('zo', '24 feb', '', 'nacht'),
  createData('ma', '25 feb', '', 'nacht'),
  createData('di', '26 feb', '', ''),
  createData('wo', '27 feb', '', ''),
  createData('do', '28 feb', '', 'ochtend'),
];
